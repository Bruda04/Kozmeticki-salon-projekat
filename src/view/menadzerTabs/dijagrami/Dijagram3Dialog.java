...
public class Dijagram3Dialog extends JDialog{

	private static final long serialVersionUID = 8516899564484509633L;
	private Controler controler;
	
	public Dijagram3Dialog(Controler controler, JFrame frame) {
		super(frame);
	...
	private void cuGui(JFrame frame) {
		...
		for (Map.Entry<StanjeZakazanogTretmana, Double> entry : controler.dijagramStatusTretmana().entrySet()) {
